...
import com.commercial.app.es_event_sync_service.special_functions.es_event_functions.shop_functions.ShopCreatedHandler;
import com.commercial.app.es_event_sync_service.special_functions.es_event_functions.shop_functions.ShopRemovedHandler;
import com.commercial.app.es_event_sync_service.special_functions.es_event_functions.shop_functions.ShopUpdatedHandler;
...
public class EsEventFunctionsRouter {
    ...
    final ShopCreatedHandler shopCreatedHandler;
    final ShopRemovedHandler shopRemovedHandler;
    final ShopUpdatedHandler shopUpdatedHandler;
    ...
    public EsEventFunctionsRouter(
        ...
        ShopCreatedHandler shopCreatedHandler,
        ShopRemovedHandler shopRemovedHandler,
        ShopUpdatedHandler shopUpdatedHandler) {
        ...
        this.shopCreatedHandler = shopCreatedHandler;
        this.shopRemovedHandler = shopRemovedHandler;
        this.shopUpdatedHandler = shopUpdatedHandler;
    }
    ...
    private Map<String, Runnable> getTypeRouter(Event event) {
        ...
        if (event.getStream().equals("SHOP")) {
            typeRoute.put("ShopCreated",
                () -> this.shopCreatedHandler.handle(event.getStreamId(), event.getPayload()));
            typeRoute.put("ShopRemoved",
                () -> this.shopRemovedHandler.handle(event.getStreamId()));
            typeRoute.put("ShopUpdated",
                () -> this.shopUpdatedHandler.handle(event.getStreamId(), event.getPayload()));
        }
        return typeRoute;
    }
}
